...
listEnv = Array(_
    ...
    Array("2.7.8"            ,"https://github.com/oneclick/rubyinstaller2/releases/download/RubyInstaller-2.7.8-1/","rubyinstaller-2.7.8-1-x64.7z" ,"bundled"),_
    Array("2.7.8-x86"        ,"https://github.com/oneclick/rubyinstaller2/releases/download/RubyInstaller-2.7.8-1/","rubyinstaller-2.7.8-1-x86.7z" ,"bundled"),_
